...
public class BuildingInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_areaObj.getText().toString().equals("")) {
						Toast.makeText(BuildingInfoEditActivity.this, "所在校区输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_buildingName.getText().toString().equals("")) {
						Toast.makeText(BuildingInfoEditActivity.this, "宿舍名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_manageMan.getText().toString().equals("")) {
						Toast.makeText(BuildingInfoEditActivity.this, "管理员输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(BuildingInfoEditActivity.this, "门卫电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传宿舍信息信息*/
					BuildingInfoEditActivity.this.setTitle("正在更新宿舍信息信息，稍等...");
	...
	private void initViewData() {
		...
		this.ET_areaObj.setText(buildingInfo.getAreaObj());
		this.ET_buildingName.setText(buildingInfo.getBuildingName());
		this.ET_manageMan.setText(buildingInfo.getManageMan());
		this.ET_telephone.setText(buildingInfo.getTelephone());
	}
	@Override
