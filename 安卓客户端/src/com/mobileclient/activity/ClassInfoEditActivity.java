...
public class ClassInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_banzhuren.getText().toString().equals("")) {
						Toast.makeText(ClassInfoEditActivity.this, "班主任姓名输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		this.dp_beginDate.init(beginDate.getYear() + 1900,beginDate.getMonth(), beginDate.getDate(), null);
	}
	@Override
