...
public class RoomInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_roomName.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "房间名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_roomTypeName.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "房间类型输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_roomPrice.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "房间价格(元/月)输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_totalBedNumber.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "总床位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_leftBedNum.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "剩余床位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_roomTelephone.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "寝室电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_roomMemo.getText().toString().equals("")) {
						Toast.makeText(RoomInfoEditActivity.this, "附加信息输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		for (int i = 0; i < buildingInfoList.size(); i++) {
			if (roomInfo.getBuildingObj() == buildingInfoList.get(i).getBuildingId()) {
				this.spinner_buildingObj.setSelection(i);
				break;
			}
		}
		this.ET_roomName.setText(roomInfo.getRoomName());
		this.ET_roomTypeName.setText(roomInfo.getRoomTypeName());
		this.ET_roomPrice.setText(roomInfo.getRoomPrice() + "");
		this.ET_totalBedNumber.setText(roomInfo.getTotalBedNumber() + "");
		this.ET_leftBedNum.setText(roomInfo.getLeftBedNum() + "");
		this.ET_roomTelephone.setText(roomInfo.getRoomTelephone());
		this.ET_roomMemo.setText(roomInfo.getRoomMemo());
	}
	@Override
