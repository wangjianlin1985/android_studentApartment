				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNumber","studentName","sex","classInfoId","birthday","telephone","studentPhoto" },
	        					new int[] { R.id.tv_studentNumber,R.id.tv_studentName,R.id.tv_sex,R.id.tv_classInfoId,R.id.tv_birthday,R.id.tv_telephone,R.id.iv_studentPhoto,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				map.put("studentName", studentList.get(i).getStudentName());
				map.put("sex", studentList.get(i).getSex());
				map.put("classInfoId", studentList.get(i).getClassInfoId());
