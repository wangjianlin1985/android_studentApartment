				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new ClassInfoSimpleAdapter(ClassInfoListActivity.this, list,
	        					...
	        					new String[] { "classNo","className","banzhuren","beginDate" },
	        					new int[] { R.id.tv_classNo,R.id.tv_className,R.id.tv_banzhuren,R.id.tv_beginDate,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < classInfoList.size(); i++) {
				...
				map.put("beginDate", classInfoList.get(i).getBeginDate());
				list.add(map);
			}
		} catch (Exception e) { 
