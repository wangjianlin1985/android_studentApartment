...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"房间信息","住宿信息","信息类型","综合信息","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, RoomInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, LiveInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, IntoTypeListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
