...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_beginDate = (TextView)convertView.findViewById(R.id.tv_beginDate);
	  /*设置各个控件的展示内容*/
	  ...
	  holder.tv_banzhuren.setText("班主任姓名：" + mData.get(position).get("banzhuren").toString());
	  try {holder.tv_beginDate.setText("成立日期：" + mData.get(position).get("beginDate").toString().substring(0, 10));} catch(Exception ex){}
	  /*返回修改好的view*/
	  return convertView; 
    } 
