...
public class BuildingInfoService {
	...
	public String AddBuildingInfo(BuildingInfo buildingInfo) {
		...
		params.put("manageMan", buildingInfo.getManageMan());
		params.put("telephone", buildingInfo.getTelephone());
	...
	public List<BuildingInfo> QueryBuildingInfo(BuildingInfo queryConditionBuildingInfo) throws Exception {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				buildingInfo.setAreaObj(object.getString("areaObj"));
				buildingInfo.setBuildingName(object.getString("buildingName"));
				buildingInfo.setManageMan(object.getString("manageMan"));
				buildingInfo.setTelephone(object.getString("telephone"));
