...
public class StudentDAO {
    ...
    public ArrayList<Student> QueryStudentInfo(String studentNumber,String studentName,ClassInfo classInfoId,String birthday,String telephone,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(null != classInfoId && !classInfoId.getClassNo().equals("")) hql += " and student.classInfoId.classNo='" + classInfoId.getClassNo() + "'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Student> QueryStudentInfo(String studentNumber,String studentName,ClassInfo classInfoId,String birthday,String telephone) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(!studentName.equals("")) hql = hql + " and student.studentName like '%" + studentName + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String studentNumber,String studentName,ClassInfo classInfoId,String birthday,String telephone) {
        Session s = factory.getCurrentSession();
        String hql = "From Student student where 1=1";
        if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
        if(!studentName.equals("")) hql = hql + " and student.studentName like '%" + studentName + "%'";
