...
public class ClassInfoDAO {
    ...
    public ArrayList<ClassInfo> QueryClassInfoInfo(String classNo,String className,String banzhuren,String beginDate,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!banzhuren.equals("")) hql = hql + " and classInfo.banzhuren like '%" + banzhuren + "%'";
    	if(!beginDate.equals("")) hql = hql + " and classInfo.beginDate like '%" + beginDate + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<ClassInfo> QueryClassInfoInfo(String classNo,String className,String banzhuren,String beginDate) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From ClassInfo classInfo where 1=1";
    	if(!classNo.equals("")) hql = hql + " and classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) hql = hql + " and classInfo.className like '%" + className + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String classNo,String className,String banzhuren,String beginDate) {
        Session s = factory.getCurrentSession();
        String hql = "From ClassInfo classInfo where 1=1";
        if(!classNo.equals("")) hql = hql + " and classInfo.classNo like '%" + classNo + "%'";
        if(!className.equals("")) hql = hql + " and classInfo.className like '%" + className + "%'";
