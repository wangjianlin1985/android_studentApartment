...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    ...
    <td width=70%><input type="text" readonly  id="classInfo.beginDate"  name="classInfo.beginDate" onclick="setDay(this);" value='<%=beginDateSDF.format(classInfo.getBeginDate()) %>'/></td>
  </tr>
